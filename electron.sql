...
-- ----------------------------
INSERT INTO `admin_web_user` VALUES (11825954456, 'admin', 'lwz', '1241415i@gmail.com', '$2a$12$E5akMSyHVijdiACdBBTZ4.QHv6w3og8Bz5.DCKnozHzc.U.ZEDVwC', 1231513151, '2025-05-26 18:27:33', '127.0.0.1', 37.5);
...
-- Records of region
-- ----------------------------
INSERT INTO `region` VALUES (1, '北京', '京', '2025-05-26 11:59:50');
INSERT INTO `region` VALUES (2, '上海', '沪', '2025-05-26 11:59:47');
INSERT INTO `region` VALUES (3, '广州市', '粤', '2025-05-26 11:59:58');
...
CREATE TABLE `order`  (
  ...
  INDEX `order_user_project_id_index`(`user_project_id` ASC) USING BTREE,
  INDEX `order_admin_id_index`(`admin_id` ASC) USING BTREE,
  INDEX `order_user_id_index`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 476 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户购买的订单' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order
-- ----------------------------
INSERT INTO orders VALUES (467, 1924352187670147074, '2025-05-22 18:33:52', 4, 11111111111, 132, 0.2, 0, NULL, 1925129632954384386, NULL);
INSERT INTO orders VALUES (468, 1924352187670147074, '2025-05-22 18:34:00', 4, 19971539844, 132, 0.2, 0, NULL, 1925129632954384386, NULL);
INSERT INTO orders VALUES (469, 1924352187670147074, '2025-05-22 18:34:08', 4, 12345345634, 132, 0.2, 0, NULL, 1925129632954384386, NULL);
INSERT INTO orders VALUES (470, 1924352187670147074, '2025-05-22 18:34:14', 4, 12345445544, 132, 0.2, 0, NULL, 1925129632954384386, NULL);
INSERT INTO orders VALUES (471, 1924352187670147074, '2025-05-22 18:35:22', 5, 47564054, 123, 0.2, 1, '202595', 1925129632954384386, NULL);
INSERT INTO orders VALUES (472, 1924352187670147074, '2025-05-22 18:38:36', 1, 11111111111, 12.5, 0.2, 0, NULL, 1925129632954384386, NULL);
INSERT INTO orders VALUES (473, 1924352187670147074, '2025-05-23 11:51:21', 2, 1348145965899, 2, 0.2, 0, NULL, 1925129632954384386, NULL);
INSERT INTO orders VALUES (474, 1924352187670147074, '2025-05-23 13:25:15', 3, 19954459331, 2.5, 0.2, 2, NULL, 1925129632954384386, NULL);
INSERT INTO orders VALUES (475, 1924352187670147074, '2025-05-24 17:40:53', 2, 47567094, 2, 0.2, 2, '【京东】註冊驗證碼：651229。京東客服絕不會索取此驗證碼，切勿轉發或告知他人。', 1925129632954384386, 1);
...
INSERT INTO `users` VALUES (1924352187670147074, '111111', '$2a$12$bxKVlDRSfxguYnUxjgs.f.EnUKREDk61DjlxRtIHrWzvROKbNp/CW', 'ryryte', NULL, '2025-05-19 14:31:29', NULL, 'http://123.51.208.249:9000/useravatar/2025/05/262afd3f78-ce09-40a8-af9f-06c1a1148f06-1743390640179.jpg', 1, '2025-05-26 17:27:27', 'c51ddeb799e845458a5a', 9327.2);
